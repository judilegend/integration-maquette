<template>
  <header class="bg-white shadow-md sticky top-5 z-50 mr-10 rounded-md">
          ...
          <div class="flex-shrink-0 flex items-center">
            <div class="relative">
              <input
                type="text"
                placeholder="Search..."
                class="pl-10 pr-4 py-2  rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              />
              <div
